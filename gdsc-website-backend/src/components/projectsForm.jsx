        ...
        <div class="max-w-md mx-auto bg-white border border-gray-300 shadow-sm rounded-xl p-6 space-y-4">
            <form onSubmit={submit}>
                ...
                <div>
                    ...
                    <input type="text" id="tags" name="tags" placeholder="e.g. AI, robotics, ML" class="w-full border border-gray-300 rounded-lg mb-4 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
